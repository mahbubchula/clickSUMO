...
Build Date UTC : 04 October 2024 06:05:03
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="https://sumo-dlr-de.translate.goog/docs/Downloads.html?_x_tr_sl=en&_x_tr_tl=hu">Magyar</a>
...
<div class="navbar-light navbar-expand-md bs-sidebar hidden-print affix" role="complementary">
    ...
    <div id="toc-collapse" class="navbar-collapse collapse card bg-secondary toc-scroll toc">
        <ul class="nav flex-column bs-sidenav">
            ...
            <li class="nav-item main"><a href="#sumo_-_latest_release_version_1200">SUMO - Latest Release (Version 1.20.0)</a></li>
                ...
                <li class="nav-item" style="text-indent: 25px;">
                    <a href="#application_launchers" class="nav-link">&rarr; Application launchers</a>
                </li>
                <li class="nav-item" style="text-indent: 5px;">
...
<h1 id="sumo_-_latest_release_version_1200">SUMO - Latest Release (Version 1.20.0)<a class="headerlink" href="#sumo_-_latest_release_version_1200" title="Permanent link">#</a></h1>
<p><strong>Release date:</strong> 07.05.2024</p>
...
<ul>
<li>64-bit installer: <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.20.0/sumo-win64-1.20.0.msi">sumo-win64-1.20.0.msi</a><?php getInfo("sumo-win64-1.20.0.msi","r",false);?></li>
<li>64-bit zip: <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.20.0/sumo-win64-1.20.0.zip">sumo-win64-1.20.0.zip</a><?php getInfo("sumo-win64-1.20.0.zip","r",false);?></li>
<li>64-bit installer with all extras (contains GPL code): <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.20.0/sumo-win64extra-1.20.0.msi">sumo-win64extra-1.20.0.msi</a><?php getInfo("sumo-win64extra-1.20.0.msi","r",false);?></li>
<li>64-bit zip with all extras (contains GPL code): <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.20.0/sumo-win64extra-1.20.0.zip">sumo-win64extra-1.20.0.zip</a><?php getInfo("sumo-win64extra-1.20.0.zip","r",false);?></li>
</ul>
...
<ul><li>Windows binaries: <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.20.0/sumo-game-1.20.0.zip">sumo-game-1.20.0.zip</a><?php getInfo("sumo-game-1.20.0.zip","r",false);?></li></ul>
...
<p>To add the most recent sumo to your ubuntu you will need to do:</p>
<div class="codehilite"><pre><span></span><code><span class="n">sudo</span><span class="w"> </span><span class="n">add</span><span class="o">-</span><span class="n">apt</span><span class="o">-</span><span class="n">repository</span><span class="w"> </span><span class="n">ppa</span><span class="p">:</span><span class="n">sumo</span><span class="o">/</span><span class="n">stable</span><span class="w"></span>
...
<span class="n">sudo</span><span class="w"> </span><span class="n">apt</span><span class="o">-</span><span class="n">get</span><span class="w"> </span><span class="n">install</span><span class="w"> </span><span class="n">sumo</span><span class="w"> </span><span class="n">sumo</span><span class="o">-</span><span class="n">tools</span><span class="w"> </span><span class="n">sumo</span><span class="o">-</span><span class="n">doc</span><span class="w"></span>
</code></pre></div>
...
<div class="codehilite"><pre><span></span><code><span class="n">yum</span><span class="o">-</span><span class="n">config</span><span class="o">-</span><span class="n">manager</span><span class="w"> </span><span class="o">--</span><span class="n">add</span><span class="o">-</span><span class="n">repo</span><span class="o">=</span><span class="n">https</span><span class="p">:</span><span class="o">//</span><span class="n">download</span><span class="o">.</span><span class="n">opensuse</span><span class="o">.</span><span class="n">org</span><span class="o">/</span><span class="n">repositories</span><span class="o">/</span><span class="n">science</span><span class="p">:</span><span class="o">/</span><span class="n">dlr</span><span class="o">/</span><span class="n">CentOS_7</span><span class="o">/</span><span class="w"></span>
<span class="n">yum</span><span class="w"> </span><span class="n">install</span><span class="w"> </span><span class="o">-</span><span class="n">y</span><span class="w"> </span><span class="o">--</span><span class="n">nogpgcheck</span><span class="w"> </span><span class="n">epel</span><span class="o">-</span><span class="n">release</span><span class="w"></span>
<span class="n">yum</span><span class="w"> </span><span class="n">install</span><span class="w"> </span><span class="o">-</span><span class="n">y</span><span class="w"> </span><span class="o">--</span><span class="n">nogpgcheck</span><span class="w"> </span><span class="n">sumo</span><span class="o">-</span><span class="mf">1.20</span><span class="o">.</span><span class="mi">0</span><span class="w"></span>
</code></pre></div>

<p>and like this, for zypper on openSUSE Leap 15.3:</p>
<div class="codehilite"><pre><span></span><code><span class="n">zypper</span><span class="w"> </span><span class="n">ar</span><span class="w"> </span><span class="n">https</span><span class="p">:</span><span class="o">//</span><span class="n">download</span><span class="o">.</span><span class="n">opensuse</span><span class="o">.</span><span class="n">org</span><span class="o">/</span><span class="n">repositories</span><span class="o">/</span><span class="n">science</span><span class="p">:</span><span class="o">/</span><span class="n">dlr</span><span class="o">/</span><span class="mf">15.3</span><span class="o">/</span><span class="w"> </span><span class="n">science</span><span class="p">:</span><span class="n">dlr</span><span class="w"></span>
<span class="n">zypper</span><span class="w"> </span><span class="ow">in</span><span class="w"> </span><span class="n">sumo</span><span class="o">=</span><span class="mf">1.20</span><span class="o">.</span><span class="mi">0</span><span class="w"></span>
</code></pre></div>

<p>I you leave out the version number it will install the latest nightly build.</p>
<p>Direct installation without adding the repository can be done in CentOS 8 like this:</p>
<div class="codehilite"><pre><span></span><code><span class="n">sudo</span><span class="w"> </span><span class="n">yum</span><span class="w"> </span><span class="o">--</span><span class="n">nogpgcheck</span><span class="w"> </span><span class="o">--</span><span class="n">repofrompath</span><span class="o">=</span><span class="n">centos</span><span class="p">,</span><span class="n">https</span><span class="p">:</span><span class="o">//</span><span class="n">download</span><span class="o">.</span><span class="n">opensuse</span><span class="o">.</span><span class="n">org</span><span class="o">/</span><span class="n">repositories</span><span class="o">/</span><span class="n">science</span><span class="p">:</span><span class="o">/</span><span class="n">dlr</span><span class="o">/</span><span class="n">CentOS_8</span><span class="w"> </span><span class="n">install</span><span class="w"> </span><span class="n">sumo</span><span class="w"></span>
</code></pre></div>

<p>More instructions on how to install from open build service are
<a href="https://software.opensuse.org//download.html?project=science%3Adlr&amp;package=sumo">here for the main project</a>
and <a href="https://software.opensuse.org//download.html?project=home%3Abehrisch&amp;package=sumo">here for the playground</a>.</p>
<p>Ubuntu, Debian and Arch users please see the community repositories above.</p>
<h2 id="macos">macOS<a class="headerlink" href="#macos" title="Permanent link">#</a></h2>
<p>You can read the Homebrew-based installation guide <a href="Installing/index.html#macos">here</a> or follow the Build instructions <a href="Installing/MacOS_Build.html">here</a>.</p>
<p>"Bottles" are available for installing with
<a href="https://brew.sh/">Homebrew</a>. They are built for the three most recent
...
brew will compile SUMO from source. For details, see the <a href="https://github.com/DLR-TS/homebrew-sumo/blob/main/README.md">Formula's
README</a>.</p>
<h3 id="application_launchers">Application launchers<a class="headerlink" href="#application_launchers" title="Permanent link">#</a></h3>
...
<ul>
<li><a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.20.0/sumo-src-1.20.0.tar.gz">sumo-src-1.20.0.tar.gz</a><?php getInfo("sumo-src-1.20.0.tar.gz","r",false);?></li>
<li><a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.20.0/sumo-src-1.20.0.zip">sumo-src-1.20.0.zip</a><?php getInfo("sumo-src-1.20.0.zip","r",false);?></li>
</ul>
...
<p>This should work for Windows, macOS and all Linux versions which are more recent than 2014.
...
<div class="codehilite"><pre><span></span><code>python -m venv sumo_test
cd sumo_test
. bin/activate
...
<p>The nightly builds are also available as <a href="https://sumo.dlr.de/daily/wheels/">Python wheels</a>.
...
<div class="codehilite"><pre><span></span><code>pip install -f https://sumo.dlr.de/daily/wheels/ eclipse-sumo
</code></pre></div>
...
<p>The Linux <a href="#repositories">repositories</a> at the open build service contain a nightly build as well.
This is unfortunately not the case for the Debian, Ubuntu and Arch versions.</p>
...
<a href="https://eclipse.org/legal/epl-v20.html">EPL-2.0</a> with GPL v2 or later as a secondary license option using only <a href="Libraries_Licenses.html">open
